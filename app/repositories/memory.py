...
class InMemoryProjectRepo:
    ...
    def __init__(self) -> None:
        self._data: dict[str, Project] = {} # dict utiliza hashtable
    ...
    def list(self) -> list[Project]:
        return list(self._data.values()) # devuelve todos los valores de proyecto
...
class InMemoryTaskRepo:
    ...
    def delete(self, task_id: str) -> None:
        ...
        del self._data[task_id] #elimina de memoria las tareas del proyecto
