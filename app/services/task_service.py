...
class TaskService:
    ...
    def create_task(self, project_id: str, title: str, task_type: str, due_date: date | None) -> Task:
    ...
    def update_task(self, task_id: str, title: str | None, due_date: date | None, status: TaskStatus | None) -> Task:
